function data = poroForward(params,constants)
...
for i = 1:size(params,2)-1
  E_sandStr   = strcat( E_sandStr,   num2str( 10^params{i}{1} ), ',' );
  k_sandStr   = strcat( k_sandStr,   num2str( 10^params{i}{2} ), ',' );
  mu_sandStr  = strcat( mu_sandStr,  num2str( params{i}{3} ),    ',' );
  n_sandStr   = strcat( n_sandStr,   num2str( params{i}{4} ),    ',' );
  a_sandStr   = strcat( a_sandStr,   num2str( params{i}{5} ),    ',' );
  E2_sandStr  = strcat( E2_sandStr,  num2str( 10^params{i}{6} ), ',' );
  k2_sandStr  = strcat( k2_sandStr,  num2str( 10^params{i}{7} ), ',' );
  mu2_sandStr = strcat( mu2_sandStr, num2str( params{i}{8} ),    ',' );
  n2_sandStr  = strcat( n2_sandStr,  num2str( params{i}{9} ),    ',' );
  a2_sandStr  = strcat( a2_sandStr,  num2str( params{i}{10} ),   ',' );
end

E_sandStr   = strcat( E_sandStr,   num2str( 10^params{end}{1}  ) );
k_sandStr   = strcat( k_sandStr,   num2str( 10^params{end}{2}  ) );
mu_sandStr  = strcat( mu_sandStr,  num2str( params{end}{3}     ) );
n_sandStr   = strcat( n_sandStr,   num2str( params{end}{4}     ) );
a_sandStr   = strcat( a_sandStr,   num2str( params{end}{5}     ) );
E2_sandStr  = strcat( E2_sandStr,  num2str( 10^params{end}{6}  ) );
k2_sandStr  = strcat( k2_sandStr,  num2str( 10^params{end}{7}  ) );
mu2_sandStr = strcat( mu2_sandStr, num2str( params{end}{8}     ) );
n2_sandStr  = strcat( n2_sandStr,  num2str( params{end}{9}     ) );
a2_sandStr  = strcat( a2_sandStr,  num2str( params{end}{10}    ) );
...
model.param.set('param_E',   num2str(10^params{1}{1}) );
model.param.set('param_k',   num2str(10^params{1}{2}) );
model.param.set('param_mu',  num2str(params{1}{3})    );
model.param.set('param_n',   num2str(params{1}{4})    );
model.param.set('param_a',   num2str(params{1}{5})    );
model.param.set('param_E2',  num2str(10^params{1}{6}) );
model.param.set('param_k2',  num2str(10^params{1}{7}) );
model.param.set('param_mu2', num2str(params{1}{8})    );
model.param.set('param_n2',  num2str(params{1}{9})    );
model.param.set('param_a2',  num2str(params{1}{10})   );
...
model.result.dataset('cpt1').set('pointx', '1000,100,100,200,200,200,10000,10000,10000');
model.result.dataset('cpt1').set('pointy', '50,150,1050,50,150,1050,50,150,1050');
...
model.result.numerical('pev1').set('expr', 'pf');
model.result.numerical('pev1').set('descr', 'Pressure');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', 'Pa');
model.result.numerical('pev1').setResult;
pf = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'ur');
model.result.numerical('pev1').set('descr', 'Displacement');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', 'm');
model.result.numerical('pev1').setResult;
ur = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'uz');
model.result.numerical('pev1').set('descr', 'Displacement');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', 'm');
model.result.numerical('pev1').setResult;
uz = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'poro.eZ');
model.result.numerical('pev1').set('descr', 'Strain Tensor, Z Component');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', '1');
model.result.numerical('pev1').setResult;
eZ = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'poro.eR');
model.result.numerical('pev1').set('descr', 'Strain Tensor, R Component');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', '1');
model.result.numerical('pev1').setResult;
eR = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'poro.eRZ');
model.result.numerical('pev1').set('descr', 'Strain Tensor, RZ Component');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', '1');
model.result.numerical('pev1').setResult;
eRZ = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'poro.gradUrZ');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', '1');
model.result.numerical('pev1').setResult;
gradUrZ = model.result.table('tbl1').getReal();

model.result.numerical('pev1').set('expr', 'poro.ePHI');
model.result.numerical('pev1').set('descr', 'Strain Tensor, PHI Component');
model.result.numerical('pev1').set('data', 'cpt1');
model.result.numerical('pev1').set('unit', '1');
model.result.numerical('pev1').setResult;
ePHI = model.result.table('tbl1').getReal();
